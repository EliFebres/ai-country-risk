...
Usage:
    python backend/main.py backfill restamp --diff      # show, change nothing
    python backend/main.py backfill restamp             # dump, then write
    python backend/main.py backfill restamp --revert F  # put a dump back
"""
